...
public class HeadScanActivity extends BaseActivity {
    public final static String TAG = HeadScanActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_head_scan);
    ...
    public void sendInfo(String barcode,String number){
        sendBarcode(SharedPrefsUtil.getString(this, Config.STR_USERNAME),
                SharedPrefsUtil.getString(this, Config.STR_PASSWORD), barcode,number);
    ...
    private void sendBarcode(final String name, final String password, final String barcode,final String number) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, SharedPrefsUtil.getString(mContext,Config.KEY_SERVER_IP) + Config.URL_HEAD_SCAN,
