...
public class ProductOnLineActivity extends BaseActivity {
    private final static String TAG = ProductOnLineActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.item_9);
        setContentView(R.layout.activity_product_on_line);
