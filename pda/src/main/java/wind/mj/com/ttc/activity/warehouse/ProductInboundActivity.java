...
public class ProductInboundActivity extends BaseActivity {
    public final static String TAG = ProductInboundActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.item_7);
        setContentView(R.layout.activity_product_inbound);
